    ...
    public function expense_form_submit_confirm( Request $request ) {
        ...
        try {
            $validated = $request->validate( [
                'receipt_front.*' => 'nullable|file|mimes:jpeg,png,jpg', // 画像のバリデーション
                'receipt_back.*' => 'nullable|file|mimes:jpeg,png,jpg', // 画像のバリデーション
                'date.*' => 'required|date',
